<section>
    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="phone" name="phone_number" type="text" class="mt-1 block w-full" :value="old('phone_number', $user->phone_number)" autofocus autocomplete="phone" />
        ...
        <div class="flex items-center gap-4">
            <x-button class="!w-auto" variant="primary">{{ __('Save') }}</x-button>
