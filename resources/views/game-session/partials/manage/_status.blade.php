    ...
    <form action="#" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <select id="status" name="status"
                ...
                <option value="confirmed_by_organizer">✅ Confirm Session</option>
                <option value="canceled_by_organizer">🚫 Cancel Session</option>
            </select>
        </div>
        ...
        <div id="cancel-reason-container" class="hidden">
            ...
            <textarea id="cancel_reason" name="cancel_reason" rows="3"
                      ...
                      class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200
                             focus:ring-rose-500 focus:border-rose-500 text-sm placeholder-gray-400"></textarea>
        </div>
