@php
    ...
    $styles = match($status) {
        ...
        'rejected' => 'bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-200 border-red-300 dark:border-red-600',
        'registered' => 'bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-200 border-blue-300 dark:border-blue-600',
