...
<form id="post-announcement" method="POST" action="{{ route('comment.store') }}" x-data="{ confirmed: false }" class="mb-8">
    @csrf
    ...
    <div class="mt-4">
        ...
        >
            ...
            <span class="text-sm text-gray-300 leading-relaxed">
                <strong>Yes, send this as an announcement to all confirmed participants.</strong><br>
