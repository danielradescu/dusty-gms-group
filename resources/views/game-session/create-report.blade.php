            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        @if ($gameSession->delay_until > $gameSession->start_at)
                            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                🚫 Because the starting time is greater than the moment when session should become public, this game session will never go public actually for people to join.
                            </p>
                        @else
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="p-4 rounded-md bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700">
                                    <p class="text-sm text-gray-700 dark:text-gray-300">
                                        <strong>Players set to auto-join:</strong>
                                    </p>
                                ...
                                <div class="p-4 rounded-md bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700">
                                    <p class="text-sm text-gray-700 dark:text-gray-300">
